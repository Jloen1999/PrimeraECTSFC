...
<img src="OcblDwOOr-logotipo.jpg" alt="logotipoPowerShell" width="100%" height="120px"/>
...
![img_13.png](VebuVqmMS1-img_13.png)
...
![img_12.png](mA5j-ECxtx-img_12.png)
...
![img_2.png](dotwE1g5yK-img_2.png)
...
![img_4.png](IdUn-8b8vq-img_4.png)
...
![img_5.png](41647elgJ3-img_5.png)
...
![img_6.png](daKaq4VSJy-img_6.png)
...
![img_21.png](tT9IWo2bja-img_21.png)
...
![img_22.png](IX-rnCB2VL-img_22.png)
...
![img_23.png](7tR8N6Sj3L-img_23.png)
...
![img_3.png](WtyBe_v85b--img_3.png)
...
![img_33.png](35eu7Ydu4cU-img_33.png)
...
![img_34.png](ycXJtA9L7zC-img_34.png)
...
![img_40.png](IhT2Pbltn6v-img_40.png)
...
![img_43.png](KM-QmLFolsT-img_43.png)
...
![img_44.png](nALSSsCrgih-img_44.png)

Voy a usar el que más se parece a Linux, el `ls`

![img_45.png](-8Voj6zaaXP-img_45.png)
...
![img_46.png](RbrBtOFxiTD-img_46.png)

Pero sin Alias sería algo así:
![img_47.png](eAENtsfiZqz-img_47.png)
...
![img_48.png](6LgN3kZRoMV-img_48.png)
...
![img_49.png](-YZ2srEsOVH-img_49.png)
...
![img_50.png](NvZIcBS2_DC-img_50.png)
...
![img_51.png](g5vd_SEUzdd-img_51.png)
    ...
    * Pasos:
      ...
      * Podemos comprobar que los archivos han sido movidos correctamente de tres maneras:
        ...
        3. O bien situándonos primero a la ubicación de la carpeta `set-location <carpetaCreada>` y luego ejecutar el comando `get-childItem` sin especificar ninguna ruta
           ![img_59.png](3jxAUMYHX-img_59.png)
  ...
  * Pasos:
    ...
    * Hacemos la copia:
      * Copiar una carpeta a otra:  `copy-item <carpeta_Creada> <nuevaCarpeta> -Recurse`(Parámetro `Recurse` es para que también se copie el contenido de la carpeta origen a la carpeta destino)
        ![img_60.png](B_XrfKRSEq-img_60.png)
...
[[example|Por ejemplo:]]
  ...
  * Renombrar carpetas.
      ![img_62.png](H8R2umfjk--img_62.png)
    ...
    * Renombrar archivos. Si quisiéramos renombrar al archivo foto1.jpg que habíamos creado previamente, lo hacemos de la siguiente manera.
      ![img_63.png](W2qzeQpVpK-img_63.png)

Digamos que queremos editar el contenido de un archivo.
Creamos el archivo![img_77.png](Ah0M7cdSPY-img_77.png)
...
* Desde la consola de PowerShell, para ello tendremos que instalar el editor nano o vim.
  * Instalación:
    ...
    * Primero instalamos el paquete de instalación chocolatey, que nos ayudará a instalar los editores: `Set-ExecutionPolicy Bypass -Scope Process -Force; iex ((New-Object System.Net.WebClient).DownloadString('https://chocolatey.org/install.ps1'))`
      ![img_65.png](MGw6I8As4u-img_65.png)
    * Ahora procedemos a instalar los editores:
      * nano--> `choco install nano`
        ![img_66.png](Dnehci4ZX3c-img_66.png)
      * vim-->`choco install vim`
        ![img_67.png](HTXC697rqhQ-img_67.png)
  ...
  * Procedemos a editar un archivo de tres maneras distintas:\
    ...
    1. Con el comando: `wsl nano|vim <nombre_archivo>`, tendremos que introducir la ruta absoluta del archivo como si lo estuviéramos introduciendo en una distribución de Linux del WSL.
       ![img_74.png](gmXczCxxaZx-img_74.png)
    2. Con el comando: `bash -c "nano|vim <nombre_archivo>"`
       ![img_76.png](00AdzKkC6oA-img_76.png)
    ...
    * Primero abrimos el fichero de configuración `$profile` de PowerShell, por ejemplo con el notepad.
      ![img_78.png](3ryBWhfBkzO-img_78.png)
    * Luego añadimos las siguientes líneas:
    ...
    ![img_75.png](tBl0Gw0Wsvc-img_75.png)
  ...
  * Ahora procedemos a leer el contenido con normalidad.
    ![img_73.png](uV-myaLN9I_-img_73.png)
...
* ***get-content:***
  ...
  * Alias:
    * cat
      [[example|Ejemplo:]]
      ![img_79.png](wx0eudZe8pB-img_79.png)
...
![img_80.png](SVgMrfR0Umr-img_80.png)
...
![img_81.png](WKqgwHGyH2Y-img_81.png)
...
![img_82.png](TBI18mjy1EA-img_82.png)
...
* ***Redireccionamiento:***
  ...
  * `>`: Crea un nuevo archivo y deposita en él la salida del cmdlet.
    ![img_85.png](_GzHGDnUAun-img_85.png)
  * `>>`: Añade al contenido del archivo la salida del cmdlet.
    Solo he añadido la fecha ![img_87.png](UYxp456QD0v-img_87.png)
...
![img_88.png](RvNSpuWNNgZ-img_88.png)
...
![img_89.png](ucNo4ZYztur-img_89.png)
...
![img_90.png](4lP8WrlTBYF-img_90.png)
...
![img_91.png](ThsYFrvKpbr-img_91.png)

Para ejecutarlo simplemente escribimos la ruta del archivo punto PS1.
![img_92.png](1ZtrqsGsdb6-img_92.png)

![img_93.png](7QUZjhSdN4q-img_93.png)
...
![img_94.png](uGE6g7ZjgJp-img_94.png)
...
![img_95.png](vjBmm-0Db1c-img_95.png)
O bien solo las líneas que seleccionemos desde la opción ejecutar selección![img_96.png](GWHmKQsNXbJ-img_96.png)
...
![img_97.png](nDteqeM_JJq-img_97.png)
...
![img_98.png](8E8Qwy8ZY0e-img_98.png)
![img_99.png](M4cS_7grQyb-img_99.png)
...
* ***Comentarios:***
  ...
  * Hay dos formas de comentarios:
    ...
    * En bloque:
    ...
    ![img_100.png](A2Mk7eYRuLY-img_100.png) Si los comentarios están bien hechos no debería mostrar el texto comentado.
* ***Variables:***
...
![img_101.png](PZ9jKn9o69W-img_101.png)
...
![img_106.png](7569gsgRFBA-img_106.png)
...
* Evaluamos una condición según si hay conexión o no con la estructura condicional if-else.
  * if: si se cumple nos mostrará el mensaje "$ip conexión establecida".
    ![img_109.png](ZqmBkwxpgQ_-img_109.png)
  * else: "$ip Error de conexión".
    Esta IP no está en nuestra red ![img_110.png](lZfwr-ZOAZh-img_110.png)
...
![img_111.png](pONqbdgsM5B-img_111.png) En este fichero tenemos las IP de los servidores.
![img_112.png](YPIuCQ2h7rU-img_112.png)
...
![img_113.png](VxTkoA917Wl-img_113.png)
...
![img_114.png](p2cUuYtvWCp-img_114.png)
